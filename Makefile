...
install:
	...
	for i in $(NATIVEFILESINC) $(GLOBFILESINC) $(VFILESINC) $(VOFILESINC); do \
	 install -m 0644 $$i "$(DSTROOT)"$(COQLIBINSTALL)/Mmx/`basename $$i`; \
	done
...
.merlin:
	...
	@echo "B /home/delgado/Documents/master/PSTL/little_mmx_encode-decode/src" >> .merlin
	@echo "S /home/delgado/Documents/master/PSTL/little_mmx_encode-decode/src" >> .merlin
